...
const Franchising = () => {
  return (
    <div>
      <div className="">
        <img className="object-cover w-full" src={img_Franchising_Banner}></img>
      </div>
      <div className="w-[76%] mx-auto pt-10">
        <div className="">
          <p className="font-nexa_bold text-[50px]">FRANCHISING</p>
        ...
        <div className="flex  justify-center gap-10 pt-10">
          <div className="flex flex-col gap-10">
            <div className="flex items-center justify-between  ">
              <p className="font-nexa_bold text-[20px]">*FIRST NAME : </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
                placeholder="First Name"
              ></input>
            </div>
            <div className="flex items-center justify-between ">
              <p className="font-nexa_bold text-[20px]">*LAST NAME : </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
            ...
            <div className="flex items-center justify-between">
              <p className="font-nexa_bold text-[20px]">*ADDRESS : </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
                placeholder="Address"
              ></input>
            ...
            <div className="flex items-center justify-between">
              <p className="font-nexa_bold text-[20px]">COUNTRY : </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
                placeholder="Contry"
              ></input>
            ...
            <div className="flex items-center justify-between">
              <p className="font-nexa_bold text-[20px] ">*STATE PROVIDE: </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
            ...
            <div className="flex flex-col gap-10">
              <div className="w-full   flex justify-end">
                <p className="w-[600px] text-right text-[20px] font-nexa_bold">
                  *Please describe your business background/restaurant
                  experience including name(s) of franchise brands :{" "}
                </p>
              </div>
              <div className="flex justify-end">
                <input className=" w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"></input>
              </div>
            </div>
          </div>
          <div className="flex flex-col justify-center gap-10">
            <div className="flex items-center justify-between  ">
              <p className="font-nexa_bold text-[20px]">CITY: </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
                placeholder="Locate"
              ></input>
            ...
            <div className="flex items-center justify-between ">
              <p className="font-nexa_bold text-[20px]">ZIP/POSTAL CODE: </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
            ...
            <div className="flex items-center justify-between">
              <p className="font-nexa_bold text-[20px]">*EMAIL : </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
                placeholder="Email"
              ></input>
            ...
            <div className="flex items-center justify-between">
              <p className="font-nexa_bold text-[20px]">MOBILE : </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
            ...
            <div className="flex items-center justify-between">
              <p className="font-nexa_bold text-[20px] ">*PREFERRED CITY 1: </p>
              <input
                className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
            ...
            <div className="flex flex-col gap-10">
              <div className="flex items-center justify-between ">
                <p className="font-nexa_bold text-[20px] uppercase">
                  *Net Worth :
                </p>
                <input
                  className="w-[420px] h-10 border-[1px] border-[#707070] rounded-xl p-2"
