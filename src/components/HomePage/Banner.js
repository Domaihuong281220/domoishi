...
const Banner = () => {
    return (
        ...
        <div className="w-full h-[100vh] pv:max-md:h-fit pv:max-md:mx-[12%] lg:h-fit relative">
            ...
            <div className="absolute top-0 h-[100vh] pv:max-md:h-fit flex flex-col justify-center  2xl:ml-[20rem] lg:ml-60 2xl:pt-20 lg:pt-32 pv:max-md:mt-12">
