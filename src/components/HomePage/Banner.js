...
const Banner = () => {
    return (
        ...
        <div className="w-full h-[100vh] pv:max-md:h-fit pv:max-md:px-[12%] lg:h-fit relative">
            <img src={BannerImg} alt="Healthy meal" className="w-full object-contain pv:max-md:h-fit pv:max-md:pl-0 pv:max-md:pt-0 pv:max-md:w-[20rem] 2xl:pr-40 pl-56 pt-16 h-[100vh] lg:h-fit lg:pt-0 lg:object-cover" />
            <div className="absolute z-40 top-0 h-[100vh] pv:max-md:h-fit flex flex-col justify-center  2xl:ml-[20rem] lg:ml-60 2xl:pt-20 lg:pt-32 pv:max-md:mt-12">
