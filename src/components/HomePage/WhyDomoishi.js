    ...
    return (
        ...
        <div className="w-full h-fit px-[12%] pv:max-md:px-[8%] flex flex-col items-center justify-center">
            ...
            <div class="relative w-[90%] 2xl:h-[75vh] lg:h-[34rem] pv:max-md:h-48 pv:max-md:mt-12">
                ...
                <div class="... z-30 absolute top-[3rem] 2xl:left-8 lg:left-[-2rem] pv:max-ph:left-4 flex h-fit 2xl:w-[84rem]  ph:max-md:w-52 pv:max-ph:w-48  pv:max-md:top-[-1rem] xl:w-[40rem] lg:w-[30rem] items-center justify-center ">
