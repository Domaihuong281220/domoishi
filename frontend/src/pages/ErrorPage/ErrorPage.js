    ...
    <div className="pt-[90px]">
      ...
      >
        <g id="Layer_12 yellow-back-fig" data-name="Layer 12">
          ...
          <g id="round-conf">
            <path
              className="fill-[#9623F0]circle c1"
            ...
            />
            <path
              className="fill-[#9623F0] circle c2"
            ...
            />
            <path
              className="fill-[#9623F0] circle c3"
            ...
            />
            <path
              className="fill-[#9623F0] circle c4"
            ...
            />
            <path
              className="fill-[#9623F0] circle c5"
            ...
            />
            <path
              className="fill-[#9623F0] circle c6"
        ...
        <g id="clock" data-name="Layer 8">
          ...
          />
          <rect
            className="fill-[#0B2470] clock-hand-1"
            x={845}
            y="189.5"
            width="6.04"
            height={58}
          ...
          />
          <rect
            className="fill-[#0B2470] clock-hand-2"
            x={845}
            y="209.5"
            width="6.04"
            height={38}
      ...
      <div className="flex justify-center py-4">
        <button
          className="flex justify-center bg-secondary1 px-4 py-2 rounded-2xl hover:bg-secondary2"
