    ...
    return (
        <div className='w-full px-[12%] pv:max-lg:px-[8%] relative'>
            <img
                src={xoxo}
                alt=''
                className='absolute top-[50rem] 2xl:top-[65rem]  pv:max-md:w-20  pv:max-md:top-[23rem] md:max-mdmax:w-32 md:max-mdmax:top-[65vw]  lg:w-44 lg:max-xl:top-[61vw] right-0 z-40 2xl:w-60 pv:max-lg:hidden'
            />
            ...
            <div class='grid grid-cols-4 gap-4 my-[3vw]'>
                <div onClick={handleUpEvent}>
                    ...
                    <p className='font-nexa_bold w-full  text-[1vw] pv:max-md:text-[8px] 2xl:text-2xl'>
                        HOUSE MILK TEA
                    </p>
                    <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                        Fresh Brewed Thai Tea W. Premium Cream & Boba
                    </p>
                </div>
                <div>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Premium House Blend Black Tea W. Cream & Boba
                        </p>
                    </div>
                </div>
                <div>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Special Crafted Brown Sugar Boba Paired With Creamy
                            Milk
                        </p>
                    </div>
                </div>
                <div>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Smooth Cold & Creamy Organic Japanese Green Tea
                        </p>
                    </div>
                </div>
                <div>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Traditional Blend Of Milk And Oolong Tea.
                        </p>
                    </div>
                </div>
                <div>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Classic Milk Tea Paired With Delicious Cold-Brewed
                            Coffee
                        </p>
                    </div>
                </div>
                <div>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Hand Crafted Taro Tea W. Cream & Boba
                        </p>
                    </div>
                </div>
                <div>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Premium House Blend Black Choice Jasmine Green Tea
                            W. Fresh Cream & Boba
                        </p>
                    </div>
                </div>
            ...
            <div class='grid grid-cols-3 gap-4  px-[12%]'>
                <div class=''>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Sparkling Strawberry Infused W. Peach Flavor Syrup
                        </p>
                    </div>
                </div>
                <div class=''>
                ...
                <div class=''>
                    <div>
                        ...
                        <p className='font-svn_rust font-semibold  text-[1vw] pv:max-md:text-[8px] px-4  pv:max-md:px-0 pv:max-md:leading-[10px]  py-2'>
                            Jasmine Green Tea W. Floral Aroma And Yogurt Syrup
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <table class=' divide-y divide-black table-fixed w-full'>
                                <tbody class='divide-y divide-black'>
                                    <tr className='divide-x divide-black'>
                                        <td class='0 py-4 whitespace-nowrap font-nexa_bold  text-[1.5vw] '>
                                            GOLDEN FRUIT TEA
                                        </td>
                                        <td class='0 py-4 whitespace-nowrap font-nexa_bold text-[1.5vw]  '>
                                            LYCHEE ROSE TEA
            ...
            <p className='w-full text-center font-nexa_light font-bold text-5xl 2xl:text-6xl pv:max-md:text-xl pv:max-md:pt-0 pt-12'>
                SMOOTHIES & SNOW CREAM
            </p>
            ...
            <div class='flex w-full justify-start'>
                ...
                <div className=' w-[30%] flex flex-col justify-center'>
                    <p className='font-nexa_light font-black text-[#CB1313] text-left text-4xl  pv:max-md:text-base'>
                        SMOOTHIES
                    </p>
                    ...
                    <div className='flex justify-start items-center space-x-2'>
                        ...
                        <svg
                            ...
                            height='10'
                            viewBox='0 0 19.799 19.799'
                            className=' pv:max-lg:block hidden !m-0'
                        >
                            <rect
                                id='Rectangle_255'
                                data-name='Rectangle 255'
                        ...
                        <p className='font-nexa_bold text-xl  pv:max-md:text-[6px] pv:max-md:leading-[10px]'>
                            ALMOND
                        </p>
                    </div>
                    <div className='flex justify-start items-center space-x-2'>
                        ...
                        <svg
                            ...
                            height='10'
                            viewBox='0 0 19.799 19.799'
                            className=' pv:max-md:block hidden !m-0'
                        >
                            <rect
                                id='Rectangle_255'
                                data-name='Rectangle 255'
            ...
            <p className='w-full text-center font-jonitha text-[3vw] pt-[4vw]'>
                TOPPINGS
            </p>
            <div class='flex flex-col my-12 '>
                <div class='-my-1.5 overflow-x-auto'>
